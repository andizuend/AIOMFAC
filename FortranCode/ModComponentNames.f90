...
!========================================================================================================== 
    ...
    !...
    !Alkenes
    NKname(31) = "Squalene";  NKnameTeX(31) = NKname(31);  
    ...
    NKname(227) = "Sapienic_acid";  NKnameTeX(227) = "Sapienic_acid";  
    NKname(228) = "Gluconic_acid";  NKnameTeX(228) = "Gluconic_acid";
    NKname(229) = "Levulinic_acid";  NKnameTeX(229) = "Levulinic_acid";
    !...
    !Amino acids
    NKname(241) = "Serine";  NKnameTeX(241) = "Serine";         != 2-Amino-3-hydroxypropanoic acid
    NKname(242) = "Glycine";  NKnameTeX(242) = "Glycine";       != Aminoacetic acid
    NKname(243) = "Alanine";  NKnameTeX(243) = "Alanine";       != 2-Aminopropanoic acid
    ...
    NKname(402) = "CO2";  NKnameTeX(402) = "CO$_2$"; !402 for carbon dioxide CO2(aq)
    !...
    !hydroperoxides
    ...
    NKname(657) = "2-Chloro-D-Glucose";  NKnameTeX(657) = "2-Chloro-D-Glucose";  !SMILES: C(C1C(C(C(C(O1)O)Cl)O)O)O
    !...
    !Poly (ethylene glycols),  PEG
    NKname(658) = "Triethylene_glycol"; NKnameTeX(658) = "Triethylene_glycol";  
    ...
    NKname(683) = "D-Glucuronic_acid";  NKnameTeX(683) = "D-Glucuronic_acid";  
    ...
    !...
    !Esters
    NKname(837) = "Cholesteryl_oleate";  NKnameTeX(837) = NKname(837);
