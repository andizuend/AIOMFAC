...
!========================================================================================================== 
    ...
    !interface variables:
    REAL(8),DIMENSION(nindcomp),INTENT(IN) :: wtf           ![-]      mass fractions of all components
    REAL(8),DIMENSION(nneutral),INTENT(OUT) :: m_neutral    ![mol/kg] neutral component molalities
    !..........................................
...
!==========================================================================================================
    ...
    IMPLICIT NONE
    !interface variables:
    REAL(8),DIMENSION(:),INTENT(IN) :: m_neutral        ![mol/kg] neutral molalities
    REAL(8),DIMENSION(:),INTENT(IN) :: SMA, SMC         ![mol/kg] ion molalities
    REAL(8),DIMENSION(nneutral),INTENT(OUT) :: xout     ![-] neutral component mole fractions (on the basis of dissociated electrolytes) 
    !Local Variables and Parameters:
    REAL(8) :: SumIonMolalities, sum_molal
    !.........................................
...
!========================================================================================================== 
    ...
    IMPLICIT NONE
    !interface variables:
    REAL(8),DIMENSION(:),INTENT(IN)  :: wtf         !mass fractions (input); typically these are mass fractions with electrolytes
                                                    !expressed as undissociated ions (matters for the output XrespSalt values)
    REAL(8),DIMENSION(:),INTENT(OUT) :: XrespSalt   !mole fraction of the components with respect to undissociated electrolytes
    REAL(8),DIMENSION(:),INTENT(OUT) :: mrespSalt   !molality of the (undissociated) components
    !local variables:
    INTEGER(4) :: i, nnp1
    REAL(8) :: sum_wtfbyMmass, sum_saltfreeWTF
